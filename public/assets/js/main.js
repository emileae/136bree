			...
			// Settings.
				var settings = {
					...
					// Images (in the format of 'url': 'alignment').
						images: {
							'images/slideshow_images/concept_1.jpg': 'center',
							'images/slideshow_images/136_bree_render_2.jpg': 'center',
							'images/slideshow_images/floor_plan_1.jpg': 'center',
							'images/slideshow_images/concept_2.jpg': 'center',
							'images/slideshow_images/floor_plan_2.jpg': 'center',
							'images/slideshow_images/136_bree_render_1.jpg': 'center'
						},
		...
		(function() {
			...
			// Note: If you're *not* using AJAX, get rid of this event listener.
				$form.addEventListener('submit', function(event) {
					...
					axios.post('https://formspree.io/rentals@136bree.co.za', {
				    _subject: "136 Bree inquiry",
				    email: $userEmail,
						name: $userName,
						message: $userMessage,
						_gotcha: $gotcha
				  ...
				  .then(function (response) {
						console.log("is formspree working?");
